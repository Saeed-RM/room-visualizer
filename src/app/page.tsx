...
const App = () => {
    ...
    useEffect(() => {
        ...
        setRooms([
            ...
            },
            {
                ...
                name: 'Living Room',
                src: './image_2.jpg',
                floor: 'Counter - Quartz',
                wall: 'Cabinets - Matte white',
                isFavorite: false,
            },
            {
                id: 'room-003',
    ...
    const handleAddRoom = () => {
        ...
        toast(`Successfully added "${newRoom.name}"!`, {
            theme: 'dark',
    ...
    const toggleFavorite = (roomId: string) => {
        ...
        if (room && !room.isFavorite) {
            toast(`Nice job, Added to favorites`, {
                theme: 'colored',
                position: 'bottom-center',
                hideProgressBar: true,
                style: {
    ...
    const duplicateRoom = (roomId: string) => {
        ...
        toast(
            `Successfully duplicated "${newRoom.name}"! (you can find it at the end of the rooms list)`,
    ...
    return (
        <div
            ...
            style={{
                backgroundImage:
                    !showSwiper && active ? `url(${active.src})` : 'none',
            }}
        >
            <ToastProvider />
