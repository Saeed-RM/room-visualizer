...
const changeRoom = () => {
    toast(
        `TODO (do not worry, it's in our long list of never to implement backlog :))`,
        { theme: 'dark', position: 'top-center', hideProgressBar: true }
    )
}

const share = () => {
    toast(`Cannot be shared :D`, {
        theme: 'dark',
        position: 'top-center',
